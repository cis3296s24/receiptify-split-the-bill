...
!(function (a) {
				...
				function c(c) {
					function d(a, b, c) {
						...
						function e(a) {
							function b(b) {
								return (
									b + ': ' + a.getPropertyValue(b) + (a.getPropertyPriority(b) ? ' !important' : '')
								);
							}
	...
	function l(a, b, c) {
		return Promise.resolve(a)
			.then(function (a) {
				return (
					a.setAttribute('xmlns', 'http://www.w3.org/1999/xhtml'), new XMLSerializer().serializeToString(a)
				);
			})
			.then(q.escapeXhtml)
			.then(function (a) {
	...
	function m() {
		...
		function e(a) {
			return new Promise(function (b) {
				for (
					var c = window.atob(a.toDataURL().split(',')[1]), d = c.length, e = new Uint8Array(d), f = 0;
					f < d;
					f++
				)
					e[f] = c.charCodeAt(f);
